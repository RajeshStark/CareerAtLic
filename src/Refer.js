...
import {NavigationActions} from 'react-navigation'
  ...
  functionOne=()=>{
    ...
    if(name==""){
      ...
      this.setState({Error: 'Please Enter Your Friend Name'});
    }
    else if(phonenumber==""){
    //  alert('please fill the last name');
        this.setState({Error: 'Please Enter Your Friend Number'});
    }
    else if(email==""){
     ...
     <ScrollView style={{maxHeight:'100%'}}>
       <View>
         ...
         <View style={{justifyContent:'center',alignItems:'center',marginBottom:15,marginTop:10}}>
              <Text style={{fontSize:25,fontWeight:'bold',color:'black',textDecorationLine:'underline'}}>Refer Your Friend</Text>
      </View>
     <Text style={{color:'red', textAlign:'center'}}>
      { this.state.Error}
    </Text>
    <Text style={{fontSize:16, marginLeft:5}}>Enter Your Friends Name:</Text>
       <TextInput
     ...
     <Text style={{fontSize:16, marginLeft:5}}>Enter Your Friends Number:</Text>
       <TextInput
      ...
      <Text style={{fontSize:16, marginLeft:5}}>Enter Your Friends Mail-ID:</Text>
       <TextInput
